...
(def org "replikativ")
(def lib 'org.replikativ/yggdrasil)
...
(defn jar
  ...
  (b/write-pom {:class-dir class-dir
                ...
                :basis basis
                :src-dirs ["src"]
                :scm {:url "https://github.com/replikativ/yggdrasil"
                      :connection "scm:git:git://github.com/replikativ/yggdrasil.git"
                      :developerConnection "scm:git:ssh://git@github.com/replikativ/yggdrasil.git"
                      :tag (str "v" version)}
